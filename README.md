...
<!-- auto-generated by .github/scripts/generate-plugin-list.lua — do not edit this section -->

| Plugin                                      | Link                                                                   |
| ------------------------------------------- | ---------------------------------------------------------------------- |
| `./tmp`                                     | [GitHub](https://github.com/./tmp)                                     |
| `akinsho/bufferline.nvim`                   | [GitHub](https://github.com/akinsho/bufferline.nvim)                   |
| `anthropic/claude-sonnet-4-6`               | [GitHub](https://github.com/anthropic/claude-sonnet-4-6)               |
...
| `catalog.json`                              | [GitHub](https://www.schemastore.org/api/json/catalog.json)            |
...
| `diagnostics/quickfix`                      | [GitHub](https://github.com/diagnostics/quickfix)                      |
...
| `file/find`                                 | [GitHub](https://github.com/file/find)                                 |
...
| `quit/session`                              | [GitHub](https://github.com/quit/session)                              |
...
| `saghen/blink.compat`                       | [GitHub](https://github.com/saghen/blink.compat)                       |
...
| `textDocument/codeLens`                     | [GitHub](https://github.com/textDocument/codeLens)                     |
| `textDocument/inlayHint`                    | [GitHub](https://github.com/textDocument/inlayHint)                    |
| `textDocument/publishDiagnostics`           | [GitHub](https://github.com/textDocument/publishDiagnostics)           |
...
| `wakatime/vim-wakatime`                     | [GitHub](https://github.com/wakatime/vim-wakatime)                     |
